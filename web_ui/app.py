    ...
    if simulation_state['is_running'] and simulation_state['dashboard']:
        try:
            ...
            simulation_state['current_data'] = {
                'time': simulation_state['dashboard'].simulation.get_current_time(),
                'power': simulation_state['dashboard'].simulation.get_current_power(),
...
def run_scenario(scenario_name):
    ...
    if scenario_name == 'normal_operation':
        ...
        simulation_state['config']['power_setpoint'] = 1.5
    else:
...
if __name__ == '__main__':
    print("Starting Nuclear Reactor Control Simulation Web UI...")
